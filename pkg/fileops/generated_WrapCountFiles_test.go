...
func (w *WrapCountFilesWrapper) Start(rootPath string) *WrapCountFilesWrapper {
	go func() {
		defer func() {
			if r := recover(); r != nil {
				w.PanicChan <- r
...
func WrapCountFiles(t _imptest.TestReporter, fn func(string) (int, error)) *WrapCountFilesWrapper {
