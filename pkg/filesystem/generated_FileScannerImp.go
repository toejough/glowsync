...
// The method blocks until a response is injected via the test controller.
func (m *FileScannerImpMock) Next() (FileInfo, bool) {
...
// Returns the call object for further operations. Fails if no call arrives within the timeout.
func (bldr *FileScannerImpNextBuilder) InjectResults(r0 FileInfo, r1 bool) *FileScannerImpNextCall {
	validator := func(callToCheck *FileScannerImpCall) bool {
		return callToCheck.Name() == "Next"
	}
...
func (c *FileScannerImpNextCall) InjectResults(r0 FileInfo, r1 bool) {
	c.done = true
...
var (
	// Compile-time verification that FileScannerImpMock implements FileScanner.
	_ FileScanner = (*FileScannerImpMock)(nil)
)
